...
// import { addProductToCart } from '../slice/addSlice';
// import { getveiw, removeColor } from '../slice/productSlice';
...
//  console.log(veiw);
// //  const carts=useSelector((state)=>state.products.pr)
...
//                           </li>
//                           <li><i onClick={()=>dispatch(removeColor())} class="fa-solid fa-xmark"></i></li>
//                       </ul>
//                   </div>
//                     </div>
//                <div className="category">
...
//                } */}
//                 <button className='btn' onClick={() => dispatch(addProductToCart(d.id))}>{d.btnn}</button>
//               <div className="hey">
//               <div className="sizes">
// <ul className='siz'>
//    <li>28</li>
