    ...
    return(
        <>
            ...
            <i className="fa-solid fa-bars"></i>
                ...
                <a href="http://localhost:5173/"> <img src="https://breeze.swissupdemo.com/static/version1714766523/frontend/Swissup/breeze-evolution/en_US/images/logo.svg" alt="" /></a>
             <div className="order"> 
                 
                <Ul>
                   <a href="/new"><li>What's New</li></a>
                  <li>  
                    <a href="/women">Women <i className="fa-solid fa-angle-down" ></i></a>
                    <ul className='dropdown'>
                        <li className='right'> 
                            <a href="">Tops</a><i className="fa-solid fa-angle-right"></i>
                            <ul className='side'> 
                                <li>Jackets</li>
                        ...
                        <li className='bottom'>
                            <a href="">Bottoms</a><i className="fa-solid fa-angle-right"></i>
                  ...
                  <li> 
                    <a href="/men">Men <i className="fa-solid fa-angle-down" ></i></a>
                   ...
                   <li>
                   <a href="gear">Gear <i className="fa-solid fa-angle-down" ></i></a>
                   ...
                   <li>
                   <a href="/training">Training <i className="fa-solid fa-angle-down" ></i></a>
